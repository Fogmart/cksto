...
class ModelExtensionModuleSofiltershopby extends Model {
	...
	public function getOptions(){
		...
		$sql = 'SELECT o.*, od.name AS option_name FROM '.DB_PREFIX.'option AS o LEFT JOIN '.DB_PREFIX.'option_description AS od ON o.option_id = od.option_id WHERE o.type IN ('.$type.') AND od.language_id = "'.(int)$this->config->get('config_store_id').'" ' ;
		$query = $this->db->query($sql);
		return $query->rows;
	}
