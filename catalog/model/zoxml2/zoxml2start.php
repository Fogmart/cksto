...
public function doUserStart($data,$xml) {
  $parts = explode (':',$data['settings']['user_start']);
  if (isset($parts[1]))   return $this->old_doUserStart(trim($parts[0]),$data,$xml,trim($parts[1]));
  return $this->old_doUserStart($data['settings']['user_start'],$data,$xml,'');
  }
