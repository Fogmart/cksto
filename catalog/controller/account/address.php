...
class ControllerAccountAddress extends Controller {
	...
	protected function getForm() {
        ...
        $data['entry_paygroupid'] = $this->language->get('entry_paygroupid');
		...
		if (isset($this->request->post['paygroupid'])) {
			$data['paygroupid'] = $this->request->post['paygroupid'];
		} elseif (!empty($address_info)) {
			$data['paygroupid'] = $address_info['paygroupid'];
		} else {
			$data['paygroupid'] = '';
		}
        $this->load->model('account/customer_group');
        $data['paygrouplst'] = $this->model_account_customer_group->getCustomerGroups();
