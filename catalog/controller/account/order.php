...
class ControllerAccountOrder extends Controller {
	...
	public function info() {
		...
		if ($order_info) {
			...
			$data['needinvoice'] = $order_info['payment_code'] == 'bank_transfer' ? 1 : 0;
	...
	public function invoice() {
        ...
        $data['text_sup'] = $this->language->get('text_sup');
        ...
        foreach ($orders as $order_id) {
            ...
            if ($order_info) {
                ...
                if ($order_info['payment_paygroupid']){
                    $groupid = $order_info['payment_paygroupid'];
                } else {
                    $groupid = $this->customer->getGroupId();
                }
                if ($groupid == 5){
                    $data['bank'] = nl2br($this->config->get('bank_transfer_bank_yl' . $this->config->get('config_language_id')));
                }else {
