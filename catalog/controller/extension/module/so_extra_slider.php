...
class ControllerExtensionModuleSoextraslider extends Controller {
	public function index($setting) {
		...
		$readmore = $this->language->get('readmore_text');
		if($readmore){
		...
		if ($use_cache){
			...
			if (!$_data) {
				switch($data['type_layout']){
					case 'type1': $_data = $this->load->view('extension/module/so_extra_slider/default.tpl', $data); break;
					case 'type2': $_data = $this->load->view('extension/module/so_extra_slider/layout2.tpl', $data); break;
					case 'type3': $_data = $this->load->view('extension/module/so_extra_slider/layout3.tpl', $data); break;
					case 'type4': $_data = $this->load->view('extension/module/so_extra_slider/layout4.tpl', $data); break;
					case 'type5': $_data = $this->load->view('extension/module/so_extra_slider/layout5.tpl', $data); break;
				}
