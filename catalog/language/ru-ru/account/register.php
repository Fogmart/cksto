...
$_['text_your_address']    = 'Дополнительные данные';
...
$_['entry_fax']            = 'Факс';
$_['entry_company']        = 'Наименование компании';
...
$_['error_telephone']      = 'Телефон должен быть заполнен!';
$_['error_smscode']        = 'Неверный код из смс!';
...
$_['error_agree']          = 'Вы должны прочитать и согласится с пунктом "%s"!';
$_['error_inn_empty']      = 'Укажите ИНН!';

$_['error_phone_code_empty']          = '<font style=\'color: red;\'>Введите код из смс!</font>';
$_['error_phone_code_wrong']          = '<font style=\'color: red;\'>Код введен неверно!</font>';
$_['error_phone_code_ok']             = '<font style=\'color: green;\'>Телефон подтвержден</font>';

// Button
$_['button_confirmation'] = 'Подтвердить номер';
