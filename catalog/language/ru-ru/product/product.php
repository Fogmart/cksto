...
$_['text_stock']                              = 'Наличие в пунктах самовывоза:';
$_['text_instock']                            = 'Достаточное количество';
$_['text_tax']                                = 'Без НДС:';
...
$_['stock_names'] = [
    1 => 'ул. Большевитская, 131/4', 	// multistore_id=5 20-й склад (ИП)
    2 => 'ул. Кутателадзе, 7', 		//multistore_id=1 3-й склад (АЛ)
    3 => 'ул. Аэропорт, 1б', 		//multistore_id=7+4
    4 => 'ул. Петухова, 16/1', 		//multistore_id=6
    5 => 'Склад для ЮЛ' 		// multistore_id=2,3
];
