<form class="form-horizontal">
  ...
  <div id="payment-existing">
    <select name="address_id" class="form-control">
      ...
      <option value="<?php echo $address['address_id']; ?>" selected="selected"><?php echo $address['paygroup']; ?>  <?php echo $address['firstname']; ?> <?php echo $address['lastname']; ?>, <?php echo $address['address_1']; ?>, <?php echo $address['city']; ?>, <?php echo $address['zone']; ?>, <?php echo $address['country']; ?></option>
      <?php } else { ?>
      <option value="<?php echo $address['address_id']; ?>"><?php echo $address['paygroup']; ?> <?php echo $address['firstname']; ?> <?php echo $address['lastname']; ?>, <?php echo $address['address_1']; ?>, <?php echo $address['city']; ?>, <?php echo $address['zone']; ?>, <?php echo $address['country']; ?></option>
      <?php } ?>
      <?php } ?>
    </select>
  </div>
  ...
  <div id="payment-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
    ...
    <div class="form-group required">
      <label class="col-sm-2 control-label" for="input-firstname"><?php echo $entry_paygroupid; ?></label>
      <div class="col-sm-10">
        <select name="paygroupid" class="form-control">
          <option/>
          <?php foreach($paygrouplst as $one){ ?>
          <option value="<?=$one['customer_group_id']?>" ?> <?=$one['name']?></option>
          <?php } ?>
        </select>
      </div>
    </div>
