...
<div class="module <?php echo $direction_class?> <?php echo $class_suffix; ?>">
	...
	<div class="modcontent">
		...
		<!--[if gt IE 9]><!-->
		<div id="<?php echo $tag_id; ?>" class="so-deals-category first-load module"><!--<![endif]-->
			<div class="so-deals-cat-wrap">
				...
				<div class="so-deals-cat-container so-deals-cat-all" style="<?php echo $bg; ?>"	 data-ajaxurl="<?php echo "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]" ?>" >
					<div class="bg_cat"></div>
					<div class="so-deals-cat">
					<?php include("default_tabs.tpl");	?>
					</div>
