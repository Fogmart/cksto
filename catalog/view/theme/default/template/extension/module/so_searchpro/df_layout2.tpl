	...
	<div id="sosearchpro" class="sosearchpro-wrapper <?php echo $additional_class; ?>">
		...
		<div class="dropdown-menu" aria-labelledby="dropdownSearch hidden-lg hidden-md hidden-xs">
			<div class="form-search">
				...
				<button type="submit" class="button-search" name="submit_search"><span>Search</span></button>
				
			</div>
		</div>
		<div id="search<?php echo $module ?>" class="form-search hidden-sm ">
		    <?php if(!empty($categories)) { ?>
			<div class="select_category filter_type  icon-select">
				<select class="no-border" name="category_id">
					<option value="0"><?php echo $text_category_all ; ?></option>
