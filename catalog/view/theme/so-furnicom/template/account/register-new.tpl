...
<span style="float:left; margin-right:25px;"> <!--<?php print $_GET["result']; ?>--> </span>
...
<input class="addToCart btn-button" type="button" value="Ok" data-toggle="tooltip" title="" onclick="someFunc();" data-original-title="OK" style="margin-top:5px;line-height: 5px;">
...
function textsms();{
if (quantity  == sms) {  result="Код верен";}
else if (quantity  == '0'){  result='Введите код из CмC';}
else {  result='Код не верен';}
//$.ajax({
