                    ...
                    <?php if(isset($article_info_found)) { ?>
                        <div class="article-info">
                            ...
                            <div class="article-sub-title">
                                <span class="article-author"><a href="<?php echo $author_url; ?>"><i class="fa fa-user"></i> <?php echo $article_info['author_name']; ?></a></span>
                                
                                <span class="bullet">&bull;</span>
                            <?php $datetotime = strtotime($article_date_modified); ?>
                                <span class="article-date"><i class="fa fa-clock-o"></i> <?php echo  $article_date_modified ;?></span>
                               
                                <?php if($article_info['allow_comment']) { ?>
                                    <span class="bullet">&bull;</span>
                                    <span class="article-comment"><i class="fa fa-comment-o" aria-hidden="true"></i> <?php echo $total_comment; ?></span>
                                <?php } ?>  
