    	...
    	<div class="product-view product-info product-view-bg clearfix">
	        <div class="row">
				<?php //Img Gallery Block -------?>
	                <div class="content-product-left  <?php if(isset($thumbnails_position) && $thumbnails_position == 'left'){echo "col-md-6 col-xs-12"; }else { echo "class-honizol col-md-6 col-xs-12"; } ?> ">
				...
				<div class="content-product-right  <?php if(isset($thumbnails_position) && $thumbnails_position == 'left'){echo "col-md-6 col-xs-12"; }else { echo "col-md-6 col-xs-12"; } ?>">
					...
					<div class="product-box-desc">
						...
						<div class="stock">
							...
							<span>
								<?php foreach($stock_grp as $i=>$st) if ($st>0) { ?>
										<div>
...
<div class="uSocial-Share" data-pid="e11390534ffa998d6beabc64b9fc2872" data-type="share" data-options="rect,style1,default,absolute,horizontal,size48,eachCounter0,counter0" data-social="vk,fb,pinterest,twi,ok,lj,print"></div>
<!-- /uSocial -->			
					</div>
				<?php endif; ?>
				...
				<div class="producttab ">
					<div class="tabsslider  <?php if ($tabs_position == 1){ echo "vertical-tabs"; }?> col-xs-12">
						...
						<ul class="nav nav-tabs font-sn">
							...
							<?php if ($tags) : ?>
							<li class="<?php echo (!$description && !$attribute_groups && !$review_status ? 'active' : 'item_nonactive'); ?>"><a data-toggle="tab" href="#tab-4"><?php echo (!empty($soconfig_lang[$lang]["tags_tab_title"]) ? $soconfig_lang[$lang]["tags_tab_title"] : 'МЕТКИ'); ?></a></li>
							<?php endif; ?>
						...
						<div class="panel">
							<div class="panel-heading">
								<a data-toggle="collapse" data-parent="#product-accordion" href="#product-tags" class="title-head collapsed">
									<span class="arrow-up icon-arrow-up-4"></span>
									<?php echo (!empty($soconfig_lang[$lang]["tags_tab_title"]) ? $soconfig_lang[$lang]["tags_tab_title"] : 'МЕТКИ'); ?>
								</a>
							</div>
		...
		<div class="product-related-upsell">
			...
			if ($related_status && $related_position =='horizontal') :
				if (file_exists(DIR_TEMPLATE . $theme . '/template/soconfig/related.php')) include(DIR_TEMPLATE.$theme.'/template/soconfig/related.php');
				else echo 'Not found';
			endif;
			?>
			<?php //TAB RELATED UPSSELL ?>
