<div class="module <?php echo $direction_class?> <?php echo $class_suffix; ?>">
	<?php if($class_suffix == 'custom-extra-1') { ?>
	...
	<?php } else { ?>
		<?php if($disp_title_module) { ?>
			<?php
				   $title1=trim($head_name);
				   $title2= str_replace(" ", "</span>&nbsp;<span>", $title1)
				?>
				<div class="header-title">
					<h3 class="modtitle1"><span><?php echo $title2; ?></span></h3>
				</div>
		<?php } ?>
	<?php } ?>
	<div class="sub-text">
...
<div class="modcontent">
	...
	<div class="extraslider-inner products-list grid module" data-effect="<?php echo $effect; ?>">
			...
			<div class="item ">
				<?php } ?>
				<div class="product-layout item-wrap <?php echo $products_style; ?>">
							...
							<div class="left-block">
								<div class="product-image-container second_img so-quickview">
									...
									<?php if($product_image_num ==2){?>
										<img src="<?php echo $product['thumb']?>" class="img-responsive img-thumb1" alt="<?php echo $product['nameFull'] ?>">
										<img src="<?php echo $product['thumb2']?>" class="img-thumb2 img_0 img-responsive" alt="<?php echo $product['nameFull'] ?>">
									<?php }else{?>
							...
							<div class="right-block">
								...
								<?php if($display_price) { ?>
									<div  class="price">
										...
										<?php } ?>
										<?php if ($product['tax']) { ?>
											<span class="price-percent-reduction" style="display:none;" ><?php echo $objlang->get('text_tax'); ?> <?php echo $product['tax']; ?></span>
										<?php } ?>
									</div>
								<?php } ?>
								...
								<div class="item-readmore">
									<a class="btn-default" href="<?php echo $product['href'];?>" title="<?php echo $product['name']; ?>" target="<?php echo $item_link_target;?>" >
										<?php echo $readmore_text ; ?>
									</a>
								</div>
								<?php } ?>
								<?php if( $display_addtocart == 1 || $display_wishlist == 1 || $display_compare == 1) { ?>
									<!-- Begin item-content -->
									<div class="bottom-group">
										<?php if($display_addtocart || $display_readmore_link || $display_wishlist || $display_compare) { ?>
											
											<?php if ($display_compare == 1) { ?>
											<button class="compare btn-button" type="button" data-toggle="tooltip" title="<?php echo $objlang->get('button_compare'); ?>" onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-retweet"></i></button>
											<?php } ?>
