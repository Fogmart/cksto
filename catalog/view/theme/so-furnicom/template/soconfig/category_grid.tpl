	...
	<div class="product-filter filters-panel">
	  <div class="row">
		...
		<div class="short-by-show form-inline text-right col-md-10 col-sm-12">
			...
			<div class="product-compare form-group" style="margin: 0 10px"><a href="<?php echo $compare; ?>" id="compare-total" class="btn"><i class="fa fa-exchange"></i> <?php echo $text_compare; ?></a></div>
	  ...
	  <div class="row">
	   ...
	   <div class="short-by-show text-center <?php echo $short_by;?>">
		...
		<?php if (!empty($pagination)){?>
			<div class="box-pagination col-md-4 col-sm-4 col-xs-12 text-right "><?php echo $pagination; ?></div>
		<?php }?>
