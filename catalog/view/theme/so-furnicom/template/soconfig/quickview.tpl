...
<style type="text/css">
	...
	.rtl .product-view .content-product-left.class-honizol .full_slider, 
	.rtl .product-view .content-product-left.class-honizol .not_full_slider{padding: 0 20px;direction: ltr;}
</style>
			...
			<?php //Img Gallery Block -------?>
                ...
                <div class="content-product-left class-honizol  col-sm-6">
						...
						<div class="box-label">
							...
							<?php if ($product_info['price'] && $product_info['special']) : ?>
				...
				<?php if ($review_status) { ?>
				    <div class="box-review">
					   ...
					   <?php if ($rating > $i) { ?>
						    ...
						    <?php } else { ?>
						    <a class="reviews_button" href="" onclick="$('a[href=\'#tab-review\']').trigger('click'); return false;"><?php echo (isset($review) ? $review : '0 Review'); ?></a> 
					    <?php } ?>
				    </div>
				<?php } ?>
