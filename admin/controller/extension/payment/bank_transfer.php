...
class ControllerExtensionPaymentBankTransfer extends Controller {
	...
	public function index() {
		...
		$data['entry_bank_yl'] = $this->language->get('entry_bank_yl');
		...
		foreach ($languages as $language) {
			if (isset($this->request->post['bank_transfer_bank_yl' . $language['language_id']])) {
				$data['bank_transfer_bank_yl' . $language['language_id']] = $this->request->post['bank_transfer_bank_yl' . $language['language_id']];
			} else {
				$data['bank_transfer_bank_yl' . $language['language_id']] = $this->config->get('bank_transfer_bank_yl' . $language['language_id']);
			}
		}
