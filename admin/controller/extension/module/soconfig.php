...
class ControllerExtensionModuleSoconfig extends Controller {
	...
	public function  __construct($registry) {
		...
		$this->typelayouts = array(
			array(
			'key'=>'1',
			'typelayout'=>'Layout 1 <p class="font-small">(Header - Type 1,Footer - Type 1)</p>',
			'typeheader'=> array('key'=>'1', 'title'=>'Type 1 (used in Layout 1)'),
			'typefooter'=> array('key'=>'1', 'title'=>'Type 1 (used in Layout 1)'),
			),
			array(
			'key'=>'2',
			'typelayout'=>'Layout 2 <p class="font-small">(Header - Type 2,Footer - Type 1)</p>',
			'typeheader'=> array('key'=>'2', 'title'=>'Type 2 (used in Layout 2)'),
			'typefooter'=> array('key'=>'1', 'title'=>'Type 1 (used in Layout 1)'),
			),
		);
    ...
    public function index() {
		...
		foreach($stores as $storeid => $store){
			...
			if(!empty($load_config)){
				...
				echo 'Error Remove Config Themes. Pleases install module So  Themes Config';exit;
			}
