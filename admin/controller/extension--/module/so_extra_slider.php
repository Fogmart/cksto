...
class ControllerExtensionModuleSoextraslider extends Controller {
	...
	// Get Module Id New
		...
		$data['type_layout'] = array(
					'type1' => $this->language->get('layout_type1'),
					'type2' => $this->language->get('layout_type2'),
					'type3' => $this->language->get('layout_type3'),
					'type4' => $this->language->get('layout_type4'),
					'type5' => $this->language->get('layout_type5'),
		);
