...
list-style-type: none !important;
		...
		if (!isset($this->data['ascp_settings']['cache_expire'])) {
			$this->data['ascp_settings']['cache_expire'] = 36000;
		}
		if (!isset($this->data['ascp_settings']['cache_max_files'])) {
			$this->data['ascp_settings']['cache_max_files'] = 300;
		}
		if (!isset($this->data['ascp_settings']['cache_maxfile_length'])) {
			$this->data['ascp_settings']['cache_maxfile_length'] = 9437184;
		}
