...
<div id="content">
						...
						<div class="col-sm-12">
							...
							<div class="tab-pane">
								<ul class="nav nav-tabs" id="so_module">
									...
									<li>
										<a href="#type_option" data-toggle="tab">
											<?php echo $objlang->get('entry_type_option') ?>
										</a>
									</li>
									<li>
								...
								<?php //--------------------------------------------------------------------------- ?>
									<div class="tab-pane" id="module"> <?php //<!--General Option --> ?>
										...
										<div class="form-group"> <?php //<!--Position module--> ?>
											<label class="col-sm-3 control-label" for="input-position_mod"> <span data-toggle="tooltip" title="<?php echo $objlang->get('entry_position_mod_desc'); ?>"><?php echo $objlang->get('entry_position_mod'); ?> </span></label>
											<div class="col-sm-9">
												<div class="col-sm-5">
													<select name="position_mod" id="input-position_mod" class="form-control">
														<?php foreach($position_mods as $option_id => $option_value)
														{
														$selected = ($option_id == $module['position_mod']) ? 'selected' :'';
														?>
														<option value="<?php echo $option_id ?>" <?php echo $selected ?> ><?php echo $option_value ?></option>
														<?php
												}
										...
										<div class="form-group"> <?php //<!-- Cookie time --> ?>
											<label class="col-sm-3 control-label" for="input-time_cookie"> <span data-toggle="tooltip" title="<?php echo $objlang->get('entry_time_cookie_desc'); ?>"><?php echo $objlang->get('entry_time_cookie'); ?> </span> </label>
											<div class="col-sm-9">
												<div class="col-sm-5">
													<input type="text" name="time_cookie" value="<?php echo $module['time_cookie']; ?>" id="input-time_cookie" class="form-control" />
												</div>
											</div>
										</div>
								...
								<?php //--------------------------------------------------------------------------- ?>
									<div class="tab-pane" id="type_option"> <?php //<!--Type Option --> ?>
										<div class="form-group"> <?php //<!--Select type--> ?>
											<label class="col-sm-3 control-label" for="input-type_module"> <span data-toggle="tooltip" title="<?php echo $objlang->get('entry_type_module_desc'); ?>"><?php echo $objlang->get('entry_type_module'); ?> </span></label>
											<div class="col-sm-9">
												<div class="col-sm-5">
													<select name="type_module" id="input-type_module" class="form-control">
														<?php foreach($type_modules as $option_id => $option_value)
														{
														$selected = ($option_id == $module['type_module']) ? 'selected' :'';
														?>
														<option value="<?php echo $option_id ?>" <?php echo $selected ?> ><?php echo $option_value ?></option>
														<?php
														}
										...
										<div class="form-group"> <?php //<!--Style Top --> ?>
											<label class="col-sm-3 control-label" for="input-style_top"> <span data-toggle="tooltip" title="<?php echo $objlang->get('entry_style_top_desc'); ?>"><?php echo $objlang->get('entry_style_top'); ?> </span> </label>
											<div class="col-sm-9">
												<div class="col-sm-5">
													<input type="text" name="style_top" value="<?php echo $module['style_top']; ?>" id="input-style_top" class="form-control" />
												</div>
											</div>
										</div>
										<div class="form-group form-slider"> <?php //<!-- Row --> ?>
										...
										<div class="form-group form-slider"> <?php //<!--autoplay --> ?>
										...
										<div class="form-group form-slider"> <?php //<!--autoplay Timeout --> ?>
										...
										<div class="form-group form-slider"> <?php //<!--autoplay Hover Pause --> ?>
										...
										<div class="form-group form-slider"> <?php //<!--autoplay Speed--> ?>
										...
										<div class="form-group form-slider"> <?php //<!--start Position--> ?>
										...
										<div class="form-group form-slider"> <?php //<!--mouse Drag--> ?>
										...
										<div class="form-group form-slider"> <?php //<!--touch Drag--> ?>
										...
										<div class="form-group form-slider"> <?php //<!--dots--> ?>
										...
										<div class="form-group form-slider"> <?php //<!--navs--> ?>
										...
										<div class="form-group form-slider"> <?php //<!--nav Speed--> ?>
										...
										<div class="form-group form-slider"> <?php //<!--effect--> ?>
										...
										<div class="form-group form-slider"> <?php //<!--duration--> ?>
										...
										<div class="form-group form-slider"> <?php //<!--delay--> ?>
	...
	<script type="text/javascript"><!--
		...
		if($("select[name='type_module']").val() == 'list')
		{
			$('.form-slider').hide();
		}else{
			$('.form-slider').show();
		}
		$("select[name='type_module']").change(function (){
			if($(this).val() == 'list')
			{
				$('.form-slider').hide();
			}else{
