            ...
            <ul class="nav nav-pills nav-stacked" id="suppliers">
              ...
              <li style="margin-top: 50px;">
                ...
                <?php foreach ($suppliers_list as $session_key => $supplier) { ?>
                  <div class="col-sm-12" style="margin-top: 20px;"><a href="index.php?route=extension/module/zoxml2&token=<?php echo $real_token; ?>&filter_supplier=<?php echo $session_key; ?>"><?php echo $supplier; ?></a></div>
                <?php } ?>
              </li>
            </ul>
          </div>
...
<?php } ?>
            ...
            <li><a href="#tab-exceptions<?php echo $row; ?>" data-toggle="tab">ИСКЛЮЧЕНИЯ</a></li>      
          </ul>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general<?php echo $row; ?>">
                ...
                <?php if(isset($ms_sellers)) { 
                  $ms_seller = isset($supplier['settings']['ms_seller'])?$supplier['settings']['ms_seller']:0;  
                  ?>
                <div class="form-group">
                  <label class="col-sm-4 control-label">Multimerch nickname:</label>
                  <div class="col-sm-8">
                    <select name="supplier[<?php echo $session_key; ?>][settings][ms_seller]" class="form-control">
                      <option value="0" <?php echo $ms_seller==0?'selected':''; ?>>Не выбран</option>
                      <?php foreach ($ms_sellers as $ms_seller_id => $ms_seller_name) { ?>
                        <option value="<?php echo $ms_seller_id; ?>" <?php echo $ms_seller==$ms_seller_id?'selected':''; ?>><?php echo $ms_seller_name; ?></option>
                      <?php } ?>
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <select name="supplier[<?php echo $session_key; ?>][settings][supplier]" class="form-control">
                      ...
                      <option value="mpn"          <?php echo $supplier['settings']['supplier']=='mpn'?'selected':''; ?>>В поле mpn</option>
                      <option value="supplier"     <?php echo $supplier['settings']['supplier']=='supplier'?'selected':''; ?> <?php echo !empty($module['is_supplier'])?'':'disabled'; ?>>В поле supplier (если оно добавлено в таблицу product!)</option>
                    </select>
                  </div>
                </div>
...
<?php } ?>
            ...
            <div class="tab-pane" id="tab-exceptions<?php echo $row; ?>">

                <div class="form-group">
                  <label class="col-sm-3 control-label">АРТИКУЛЫ:</label>
                  <div class="col-sm-3">
                  ...
                  <div class="col-sm-6">
                    ...
                    <p>Примечание: вы можете использовать в качестве разделителя иной символ, например точку с запятой. Для этого необходимо в файле config.php добавить константу: define('zo_user_exceptions_delimiter', ';');</p>
                  </div>
                </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <div class="col-sm-12">
                          ...
                          <div class="col-sm-10"><a target="_blank" href="http://opencart.zone/modules-2-0/mcg-2.html">Мультивалютные товары 1.6 - 2.3</a></div>
                        </div>
                        <div class="col-sm-12">
                          <div class="col-sm-2">
                        ...
                        <div class="col-sm-12">
                          <div class="col-sm-2">
                            <input type="checkbox" name="module[costprice]" value="1" <?php echo isset($module['costprice'])?'checked':''; ?> class="form-control" />
                          </div>
                        ...
                        <div class="col-sm-12">
                          <div class="col-sm-2">
                            <input type="checkbox" name="module[valuta_plus]" value="1" <?php echo isset($module['valuta_plus'])?'checked':''; ?> class="form-control" />
                          </div>
                        ...
                        <div class="col-sm-12">
                          ...
                          <div class="col-sm-10"><a target="_blank" href="https://opencartforum.com/files/file/3879-mega-filter-plus-powered-by-mega-filter-pro2x/">OCMegaExtensions: Mega Filter Plus (бета)</a></div>
                        </div>
                        <div class="col-sm-12">
                          <div class="col-sm-2">
                            <input type="checkbox" name="module[hpmodel_links]" value="1" <?php echo isset($module['hpmodel_links'])?'checked':''; ?> class="form-control" />
                          </div>
                          <div class="col-sm-10"><a target="_blank" href="https://opencartforum.com/files/file/7096-ajax-zamena-tovara-po-modelyam-hyper-product-models-for-oc21x-oc23x/">HPM - Модели товара</a></div>
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <div class="col-sm-12">
                          ...
                          <div class="col-sm-10">Сортировать категории по алфавиту</div>
                          <div class="col-sm-2">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <div class="col-sm-12">
                          ...
                          <div class="col-sm-10">Генерировать ЧПУ при создании производителя</div>
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
...
var url = 'index.php?route=extension/module/zoxml2/delfeed&token=<?php echo $token; ?>';
$.ajax({
type:'post',
url: url,
data: pData,
success: function() { 
  location = 'index.php?route=extension/module/zoxml2&token=<?php echo $token; ?>'; 
  },
...
var url = 'index.php?route=extension/module/zoxml2/addfeed&token=<?php echo $token; ?>';
$.ajax({
type:'post',
url: url,
data: pData,
...
var url = 'index.php?route=extension/module/zoxml2/module&token=<?php echo $token; ?>';
$.ajax({
type:'post',
url: url,
data: pData,
...
var url = 'index.php?route=extension/module/zoxml2/addreplace&token=<?php echo $token; ?>';
$.ajax({
type:'post',
url: url,
data: pData,
...
var pData = { supplier    :session_key};
var url = 'index.php?route=extension/module/zoxml2/delreplaces&token=<?php echo $token; ?>';
$.ajax({
type:'post',
url: url,
data: pData,
...
var pData = { id    :id};
var url = 'index.php?route=extension/module/zoxml2/delreplace&token=<?php echo $token; ?>';
$.ajax({
type:'post',
url: url,
data: pData,
...
if (toxml) {
  var url = 'index.php?route=extension/module/zoxml2/settings2xml&token=<?php echo $token; ?>';
  $.ajax({
  type:'post',
  url: url,
  data: pData,
  ...
  var url = 'index.php?route=extension/module/zoxml2/settings&token=<?php echo $token; ?>';
  $.ajax({
  type:'post',
  url: url,
  data: pData,
...
var pData = {id:id};
var url = 'index.php?route=extension/module/zoxml2/delrecord&token=<?php echo $token; ?>';
$.ajax({
type:'post',
url: url,
data: pData,
...
var pData = {supplier:supplier};
var url = 'index.php?route=extension/module/zoxml2/delrecords&token=<?php echo $token; ?>';
$.ajax({
type:'post',
url: url,
data: pData,
...
var pData = {id:id};
var url = 'index.php?route=extension/module/zoxml2/delevent&token=<?php echo $token; ?>';
$.ajax({
type:'post',
url: url,
data: pData,
...
var pData = {supplier:supplier};
var url = 'index.php?route=extension/module/zoxml2/delevents&token=<?php echo $token; ?>';
$.ajax({
type:'post',
url: url,
data: pData,
...
var pData = {supplier:session_key};
var url = 'index.php?route=extension/module/zoxml2/scansupplier&token=<?php echo $token; ?>';
$.ajax({
type:'post',
url: url,
...
var pData = {supplier:session_key};
var url = 'index.php?route=extension/module/zoxml2/linksupplier&token=<?php echo $token; ?>';
$.ajax({
type:'post',
url: url,
<?php if (!isset($module['progress'])) { ?>
...
var pData = {supplier:session_key};
var url = 'index.php?route=extension/module/zoxml2/addallvendors&token=<?php echo $token; ?>';
$.ajax({
type:'post',
url: url,
data: pData,
...
var url = 'index.php?route=extension/module/zoxml2/docategoryseourl&token=<?php echo $token; ?>';
$.ajax({
type:'post',
url: url,
success: function() { 
...
var pData = {supplier:session_key};
var url = 'index.php?route=extension/module/zoxml2/addallcategories&token=<?php echo $token; ?>';
$.ajax({
type:'post',
url: url,
data: pData,
...
var pData = {supplier:session_key};
var url = 'index.php?route=extension/module/zoxml2/lostcategories&token=<?php echo $token; ?>';
$.ajax({
type:'post',
url: url,
data: pData,
...
var pData = {supplier:session_key};
var url = 'index.php?route=extension/module/zoxml2/killcategories&token=<?php echo $token; ?>';
$.ajax({
type:'post',
url: url,
data: pData,
...
var url = 'index.php?route=extension/module/zoxml2/progress&token=<?php echo $token; ?>';
$.ajax({
type:'post',
url: url,
data: pData,
success: function(json) { 
  for (var i in json) {
    ...
    if (json[i]['type']=='end') location = 'index.php?route=extension/module/zoxml2&token=<?php echo $token; ?>';
    }
  setTimeout(
    function(){
...
var pData = {supplier:session_key};
var url = 'index.php?route=extension/module/zoxml2/loadsupplier&token=<?php echo $token; ?>';
$.ajax({
type:'post',
url: url,
<?php if (!isset($module['progress'])) { ?>
...
function loadVendorPage(page,session_key) {
  ...
  var url = 'index.php?route=extension/module/zoxml2/loadvendorpage&token=<?php echo $token; ?>';
  $.ajax({
  type:'post',
  url: url,
  data: pData,
...
function loadCategoryPage(page,session_key,do_category_autocomplete) {
  ...
  html  = '<div id="categories_page_' + session_key + '"><i class="fa"></i>&nbsp;&nbsp;загрузка...</div>';
  $(id).replaceWith(html);
  $(id).children('i').addClass('fa-spinner').addClass('fa-spin');
  
  if (page=='nop') {
    html  = '<div id="categories_page_' + session_key + '"></div>';
    $(id).replaceWith(html);
    return;
    }   
  ...
  var url = 'index.php?route=extension/module/zoxml2/loadcategorypage&token=<?php echo $token; ?>';
  $.ajax({
  type:'post',
  url: url,
  data: pData,
