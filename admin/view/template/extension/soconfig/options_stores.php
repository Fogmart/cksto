...
?>
<div class="sidebar">
<h3 class="title"> <?php echo $theme;?> <span class="badge"> v1.1.0</span></h3>
				...
				<div class="so-panel">
					...
					<div class="panel-container">
						<div id="tab-general__layouttype-<?php echo $store['store_id']; ?>" class="form-group">
							...
							<div class="col-sm-10">
								<?php echo field_typelayout('soconfig_general_store',$soconfig_general_store,'typelayout',$typelayouts,4); ?>
							</div>
						</div>
							...
							<div class="so-panel">	
								...
								<div class="panel-container">
									<div class="form-group">
										...
										<div class="col-sm-8" >
											<?php echo field_langHori($languages,$storeid ,'soconfig_general_store',$soconfig_general_store,'contact_number');?>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-8" >
											<?php echo field_langHori($languages,$storeid ,'soconfig_general_store',$soconfig_general_store,'welcome_message');?>
										</div>
									</div>
				...
				<div class="clearfix so-panelType">
					...
					<div class="tab-content col-sm-10">
						...
						<div id="tab-general__footerother-<?php echo $store['store_id']; ?>" class="tab-pane">
							...
							<div class="so-panel">
								<h3 class="panel-title">Custom Block 1</h3>
								<div class="panel-container">
									<div class="form-group">
										<label class="col-sm-2 control-label" >
											 <span data-toggle="tooltip" title="Set On/Off for Custom Block 1">
												Status:
											 </span>
										</label>
										<div class="col-sm-10">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<?php echo field_langTextarea($languages,$storeid ,'soconfig_general_store',$soconfig_general_store,'footer_socials');?>
										</div>
									</div>
							...
							<div class="so-panel">
								<h3 class="panel-title">Custom Block 2</h3>
								<div class="panel-container">
									<div class="form-group">
										<label class="col-sm-2 control-label" >
											 <span data-toggle="tooltip" title="Set On/Off for Custom Block 2">
												Status:
											 </span>
										</label>
										<div class="col-sm-10">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<?php echo field_langTextarea($languages,$storeid ,'soconfig_general_store',$soconfig_general_store,'footerpayment');?>
							...
							<div class="so-panel">
								<h3 class="panel-title">Custom Block 3</h3>
								<div class="panel-container">
									<div class="form-group">
										<label class="col-sm-2 control-label" >
											 <span data-toggle="tooltip" title="Set On/Off for Custom Block 3">
												Status:
											 </span>
										</label>
										<div class="col-sm-10">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<?php echo field_langTextarea($languages,$storeid ,'soconfig_general_store',$soconfig_general_store,'customblock');?>
