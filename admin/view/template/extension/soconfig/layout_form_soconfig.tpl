			...
			<?php global $module_row;$module_row = 0; ?>
				...
				<div class="well"> 
					<div class="row">
						...
						<div class="col-md-4 col-sm-12"> 
							<?php echo create_position('Content Menu','content_menu',$layout_modules,$extensions,$module_row); ?>
						</div>
						<div class="col-md-4 col-sm-12"> 
						...
						<div class="col-lg-6 col-md-4 col-sm-12">
							<div class="row">
								...
								<?php if($layout_route['route'] == 'common/home') { ?>
									...
									<div class="col-sm-12"> 
										<?php echo create_position('Content Block 1','content_block1',$layout_modules,$extensions,$module_row); ?>
									</div>

									<div class="col-sm-12"> 
										<?php echo create_position('Content Block 2','content_block2',$layout_modules,$extensions,$module_row); ?>
									</div>

									<div class="col-sm-12"> 
										<?php echo create_position('Content Block 3','content_block3',$layout_modules,$extensions,$module_row); ?>
									</div>
									
									<div class="col-sm-12"> 
										<?php echo create_position('Content Block 4','content_block4',$layout_modules,$extensions,$module_row); ?>
									</div>

									<div class="col-sm-12"> 
										<?php echo create_position('Content Block 5','content_block5',$layout_modules,$extensions,$module_row); ?>
									</div>
									
									<div class="col-sm-12"> 
										<?php echo create_position('Content Block 6','content_block6',$layout_modules,$extensions,$module_row); ?>
...
$('#module-content_left, #module-column_right, #module-content_top, #module-content_bottom , #module-content_menu, #module-content_search,#module-footertop,#module-footerbottom').delegate('select[name*=\'code\']', 'change', function() {
...
$('#module-content_left, #module-column_right, #module-content_top, #module-content_bottom,#module-content_menu,#module-content_search,#module-footertop,#module-footerbottom').trigger('change');
//--></script> 
</div>
<?php echo $footer; ?>