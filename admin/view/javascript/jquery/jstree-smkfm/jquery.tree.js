	...
	function tree_component () {
		return {
			...
			attach_events : function () {
				...
				$(document).on('click', "#" + this.container.attr("id") + " li",
					function(event) { // WHEN CLICK IS ON THE ARROW
				...
				$(document).on('click', "#" + this.container.attr("id") + " li a",
					function (event) { // WHEN CLICK IS ON THE TEXT OR ICON
			...
			destroy : function() {
				...
				$(document).off("click.jstree", "#" + this.container.attr("id"));
				$(document).off("dblclick.jstree", "#" + this.container.attr("id"));
				$(document).off("mouseover.jstree", "#" + this.container.attr("id"));
				$(document).off("mouseout.jstree", "#" + this.container.attr("id"));
				$(document).off("mousedown.jstree", "#" + this.container.attr("id"));
