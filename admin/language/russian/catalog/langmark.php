...
$_['entry_main_title']     		= 'Заголовок страницы <br><span class="vhelp">Мета-тег: title</span>';
$_['entry_main_description']    = 'Описание страницы <br><span class="vhelp">Мета-тег: description</span>';
$_['entry_main_keywords']     	= 'Ключевые слова страницы <br><span class="vhelp">Мета-тег: keywords</span>';

$_['tab_ex']     				= 'Исключения';
$_['entry_ex_multilang']     	= 'В контроллере <br> маршрутизатора';
$_['entry_ex_multilang_route']  = 'Исключения для route';
$_['entry_ex_multilang_uri']    = 'Исключения для uri';
$_['entry_ex_url']     			= 'В контроллере <br>формирователя префиксов';
...
$_['entry_prefix']          	= 'Языковый префикс';
...
$_['entry_jazz']          		= 'Поддержка SeoPro Jazz';
