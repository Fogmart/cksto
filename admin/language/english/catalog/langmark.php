...
$_['url_module_text'] 				= 'SEO multilang';
...
$_['entry_jazz']          = 'Support SeoPro Jazz';

$_['entry_prefix_home_default'] = 'Remove language prefix <br>(if installed) <br>for the main page. the <br>Other pages <br>will be prefixed with';
$_['entry_prefix']          		= 'Language prefix';
